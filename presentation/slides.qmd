...
%%| echo: false
%%| eval: false
%% mermaid configuration for ecosystem_1_researchdata.png
flowchart LR
...
%%| echo: false
%%| eval: false
%% mermaid configuration for ecosystem_2_repositories.png
...
%%| echo: false
%%| eval: false
%% mermaid configuration for ecosystem_3_FDP.png
---
config:
  theme: 'base'
  themeVariables:
    primaryColor: '#fff'
    primaryTextColor: '#3a1e3e'
    primaryBorderColor: '#3a1e3e'
    lineColor: '#3a1e3e'
    secondaryColor: '#ffe880'
    tertiaryColor: '#fff'
...
flowchart LR
  ...
  subgraph Research[Research]
    publications[📚 Publications]
    data[📊 Tabular Data<br>🌎 Geodata]
    code[💻 Source Code]
  end

  subgraph PublicHistoryWeb[Public History]
  ...
  omeka -->|API| rdp
  github -->|static site<br>generator| rdp


style Research stroke:#3a1e3e
style Repositories stroke:#3a1e3e
style PublicHistoryWeb stroke:#3a1e3e
```
...
%%| echo: false
%%| eval: false
%% mermaid configuration for ecosystem_4_longtermarchives.png
...
subgraph Archives[Long Term Archives]
    UBBasel[(📚 Basel<br>University Library)]
    Zenodo[(📦 Zenodo)]
    DaSCH[(🏛️ DaSCH)]
  end

  publications --->|other<br>publications| Zenodo
...
%%| echo: false
%%| eval: false
%% mermaid configuration for ecosystem_5_dasch.png
---
config:
  theme: 'base'
  themeVariables:
...
![](./images/mermaid/datamodel_omeka.png){fig-align="center"}

```{mermaid}
%%| echo: false
%%| eval: false
%% mermaid configuration for datamodel_omeka.png
---
config:
  theme: 'base'
  themeVariables:
...
style Item fill:#ffe880,stroke:#3a1e3e,color:#3a1e3e
style Media fill:#fff3e0,stroke:#3a1e3e,color:#3a1e3e
```

## Data Model DaSCH (simplified 😅)

::: {layout="[[-1], [1], [-1]]"}
![](./images/mermaid/datamodel_dasch.png){fig-align="center"}
:::

```{mermaid}
%%| echo: false
%%| eval: false
%% mermaid configuration for datamodel_dasch.png
---
config:
  theme: 'base'
  themeVariables:
...
style Document fill:#ffe880
style ResourceWithoutMedia fill:#ffe880
style Image fill:#ffe880
...
::: {.column width="33%"}
![[Research Data Platform](https://forschung.stadtgeschichtebasel.ch)](./images/research_data_platform.png){fig-align="center"}
:::

::: {.column width="33%"}
![[omeka2dsp Documentation](https://dokumentation.stadtgeschichtebasel.ch/omeka2dsp)](./images/omeka2dsp_overview.png){fig-align="center"}
:::

::: {.column width="33%"}
![[Documentation Platform](https://dokumentation.stadtgeschichtebasel.ch)](./images/documentation_platform.png){fig-align="center"}
:::
