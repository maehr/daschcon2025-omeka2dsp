...
## Ensuring FAIR and long-term preservation

- Research data must be Findable, Accessible, Interoperable, and Reusable (FAIR)
- Research data must be stored in trusted repositories with proper metadata and persistent identifiers (PIDs)
- FIXME: add more
